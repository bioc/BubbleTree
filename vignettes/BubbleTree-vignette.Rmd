...
Example data in the desired format is provided as part of this package as GRanges objects and can be loaded as shown below.
...
<b>BubbleTree: an intuitive visualization to elucidate tumoral aneuploidy and clonality in somatic mosaicism using next generation sequencing data.</b> Wei Zhu, Michael Kuziora, Todd Creasy, Zhongwu Lai, Christopher Morehouse, Xiang Guo, Yinong Sebastian, Zheng Liu, Dong Shen, Jiaqi Huang, Feng Xue, Liyan Jiang, Yihong Yao, Brandon W. Higgs. Publication Pending (2015)
